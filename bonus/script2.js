    ...
    $(".grid-item").click(function () {
       ...
       /* imposto il primo IF dove se il punteggioR sarà maggiore o uguale a 14 allora l'unica classe che verrà aggiunta sarà la green --> */
            if(punteggioR >= 14){
                ...
                if(punteggioG < 15){
                    /* se entrambe le condizioni sono state rispettate faccio partire un alert che avvisa l'utente di aver vinto e pongo una condizione su quest'ultimo dove se alert (CHIEDI A NIKOLAS o SIMONE)  */
